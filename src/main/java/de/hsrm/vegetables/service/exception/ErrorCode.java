...
public enum ErrorCode {
    ...
    USER_ALREADY_HAS_ROLE(400017),
    USER_IS_LAST_ADMIN(400018),
    ITEM_NOT_IN_STOCK_YET(400019),
    MEMBER_CANNOT_USE_THIS_FILTER(400020),
    ITEM_OUT_OF_STOCK(400021),
    USER_NOT_ACTIVATED(400022),
    USER_IS_DELETED(400023),
    CANNOT_DISPOSE_DELETED_ITEM(400024),
    USER_IS_ALREADY_DELETED(400025),

    // 401
    USER_DOES_NOT_MATCH_PURCHASE(401001),
    INVALID_JWT(401002),
